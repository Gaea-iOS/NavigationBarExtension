...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jerry/NavigationBarExtension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jerry' => '445242970@qq.com' }
  s.source           = { :git => 'https://github.com/jerry/NavigationBarExtension.git', :tag => s.version.to_s }
